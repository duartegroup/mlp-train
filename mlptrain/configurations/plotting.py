...
def parity_plot(config_set: 'mlptrain.ConfigurationSet',
                name:       str = 'paritiy'
                ) -> None:
    """
...
def _all_energies_are_defined(cfgs) -> bool:
    ...
    return all(e is not None for e in cfgs.true_energies + cfgs.predicted_energies)
...
def _add_energy_parity_plot(config_set, axis) -> None:
    ...
    axis.plot([min_e, max_e], [min_e, max_e],
              c='k',
              lw=1.0)
