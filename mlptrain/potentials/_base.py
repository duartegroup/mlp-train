...
class MLPotential(ABC):
    def __init__(self, name: str, system: "mlptrain.System"):
        """
    ...
    def train(
        self, configurations: Optional["mlptrain.ConfigurationSet"] = None
    ) -> None:
        """
    ...
    def training_data(self, value: Optional["mlptrain.ConfigurationSet"]):
        ...
        **kwargs,
        ...
        for idx, freq in enumerate(hist):
            ...
            self.al_train(
                ...
                bias=mlt.Bias(
                    coordinate, kappa=10, reference=target_coord  # eV Å^-2
                ),
                **kwargs,
            )
    ...
    def set_atomic_energies(self, method_name: str) -> None:
        """
