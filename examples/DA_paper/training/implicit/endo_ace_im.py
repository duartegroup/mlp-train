...
if __name__ == '__main__':
    ...
    system = mlt.System(mol_TS, box=None)

    ace = mlt.potentials.ACE('endo_ace_wB97M_imwater', system=system)
    ...
    trajectory = mlt.md.run_mlp_md(
        configuration=TS, mlp=ace, fs=200, temp=300, dt=0.5, interval=10
    )
